...
The Aiken format is a very simple way of creating multiple choice questions using a
clear human-readable format in a text file.
...
* Non-ASCII characters like 'quotes' can cause import errors. To avoid this always save your text file in
  UTF-8 format (most text editors, even Word, will ask you).
* The answer letters (A,B,C etc.) and the word "ANSWER" must be capitalised as shown below,
